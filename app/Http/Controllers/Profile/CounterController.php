...
use App\Http\Resources\Profile\Counters\CounterHistoryResource;
...
class CounterController extends Controller
{
    ...
    public function __construct(
        ...
        private readonly UpdateProfileCounterPassportCommand $updateProfileCounterPassportCommand,
    ...
    {
        return view('pages.profile.counters.index');
    }
    ...
    public function view(string $counterUid): View
    {
        ...
        return view('pages.profile.counters.view', compact('counter'));
    }
     ...
     */
    public function passportSave(DefaultRequest $request): void
    {
        $this->updateProfileCounterPassportCommand->execute(
    ...
    public function history(DefaultRequest $request): JsonResponse
    {
        ...
        return response()->json([
            'histories' => new ResourseList($response->getItems(), CounterHistoryResource::class),
