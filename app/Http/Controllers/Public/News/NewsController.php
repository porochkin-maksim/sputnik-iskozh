...
class NewsController extends Controller
{
    ...
    public function show(int $id): mixed
    {
        ...
        return view('pages.public.news.show', compact('news', 'edit'));
    }

    public function formPage(?int $id = null): View
    {
        if ( ! $this->canEdit()) {
            abort(403);
        }
        ...
        return view('pages.public.news.form', compact('newsResource', 'categories'));
    }
    ...
    public function uploadFile(int $id, DefaultRequest $request): JsonResponse
    {
        ...
        $this->fileService->storeNewsFiles($request->allFiles(), $id);
