...
abstract class RouteNames
{
    ...
    public const string PERSONAL_DATA_CONSENT = 'personal-data-consent';
    public const string PAYMENTS_INFO         = 'payments-info';
    public const string COOKIE_POLICY         = 'cookie-policy';
    ...
    public const string NEWS_FORM        = 'news.form';
    ...
    public const string PROFILE_LOGIN_LINK_GET = 'profile.login-link.get';
    public const string PROFILE_LOGIN_LINK     = 'profile.login-link';
    ...
    public const string PROFILE_COUNTER_PASSPORT  = 'profile.counter.passport';
    ...
    public const string ADMIN_LOGIN_LINK_SEND = 'admin.login-link.send';
    ...
    public const string ADMIN_SELECTS_ROLES          = 'admin.selects.roles';
    ...
    public static function name(mixed $key, string $default = ''): string
    {
        return match ($key) {
            ...
            self::PERSONAL_DATA_CONSENT               => 'Согласие на обработку персональных данных',
            self::PAYMENTS_INFO                       => 'Информация об оплате и возврате',
            self::COOKIE_POLICY                       => 'Политика использования cookie',
