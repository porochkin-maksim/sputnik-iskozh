...
Breadcrumbs::for(RouteNames::HELP_DESK_CATEGORY, static function (BreadcrumbTrail $trail, TicketTypeEnum $type, TicketCategoryEntity $category) {
...
Breadcrumbs::for(RouteNames::HELP_DESK_SERVICE, static function (BreadcrumbTrail $trail, TicketTypeEnum $type, TicketCategoryEntity $category, TicketServiceEntity $service) {
