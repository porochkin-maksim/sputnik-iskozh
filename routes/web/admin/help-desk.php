...
Route::prefix('help-desk')->group(function () {
    Route::get('/', HelpDesk\IndexPageController::class)->name(RouteNames::ADMIN_HELP_DESK_INDEX);
    ...
    Route::prefix('settings')->group(function () {
        Route::get('/', static fn() => view('pages.admin.help-desk.settings'))->name(RouteNames::ADMIN_HELP_DESK_SETTINGS);
