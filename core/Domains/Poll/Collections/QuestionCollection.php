...
/**
 * @template-extends Collection<int, QuestionDTO>
 */
class QuestionCollection extends Collection implements CollectionInterface
{
    use CollectionTrait;

    public function checkItemInstance(mixed $item): bool
    {
        return $item instanceof QuestionDTO;
    }
}
