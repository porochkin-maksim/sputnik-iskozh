...
class UserComparator extends AbstractComparatorDTO
{
    ...
    private const string TITLE_MEMBERSHIP_DATE      = 'Дата членства';
    private const string TITLE_MEMBERSHIP_DUTY_INFO = 'Основание членства';

    private const string KEY_ACCOUNT              = 'account';
    private const string KEY_ROLE                 = 'role';
    private const string KEY_MEMBERSHIP_DATE      = 'membershipDate';
    private const string KEY_MEMBERSHIP_DUTY_INFO = 'membershipDutyInfo';
    ...
    protected const array KEYS_TO_TITLES = [
        ...
        self::KEY_MEMBERSHIP_DATE      => self::TITLE_MEMBERSHIP_DATE,
        self::KEY_MEMBERSHIP_DUTY_INFO => self::TITLE_MEMBERSHIP_DUTY_INFO,
    ];
    ...
    public function __construct(UserDTO $entity)
    {
        ...
        $this->addProperties([
            ...
            self::KEY_MEMBERSHIP_DATE      => $entity->getMembershipDate()?->format(DateTimeFormat::DATE_DEFAULT),
            self::KEY_MEMBERSHIP_DUTY_INFO => $entity->getMembershipDutyInfo(),
        ]);
