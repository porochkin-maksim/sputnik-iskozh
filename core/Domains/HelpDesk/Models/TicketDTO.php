...
class TicketDTO
{
    ...
    private ?TicketServiceDTO  $service  = null;
    ...
    public function getAccount(bool $layLoad = false): ?AccountDTO
    {
        if ( ! $this->account && $layLoad) {
    ...
    public function getUser(bool $layLoad = false): ?UserDTO
    {
        if ( ! $this->user && $layLoad) {
            $this->user = UserLocator::UserService()->getById($this->userId);
        }
    ...
    public function getService(): ?TicketServiceDTO
    {
        return $this->service;
    }

    public function setService(?TicketServiceDTO $service): static
    {
