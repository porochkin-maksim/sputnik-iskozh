...
class CounterHistoryEntity
{
    ...
    public function setCounterId(?int $counterId): static
    {
    ...
    public function setCounter(?CounterEntity $counter): static
    {
    ...
    public function setClaim(?ClaimEntity $claimDTO): static
    {
    ...
    public function setPrevious(?CounterHistoryEntity $previous): static
    {
