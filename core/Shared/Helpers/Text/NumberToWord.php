...
namespace Core\Shared\Helpers\Text;
...
class NumberToWord
{
    private const int MAX_NUMBER = 999999999999; //12 знаков

    private const int GENDER_NEUTER    = 0;
    private const int GENDER_MASCULINE = 1;
    private const int GENDER_FEMININE  = 2;
    ...
    const int DECIMAL_BIT_100        = 100;
    const int DECIMAL_BIT_1000       = 1000;
    const int DECIMAL_BIT_1000000    = 1000000;
    const int DECIMAL_BIT_1000000000 = 1000000000;

    private const array DECIMAL_BITS = [
    ...
    private const array NUMS_DECIMALS = [
