...
namespace Core\Objects\Report\Factories;
...
readonly class ReportFactory
{
    ...
    public function makeDtoFromObject(Report $report): ReportDTO
    {
        ...
        $result
            ...
            ->setYear($report->year)
            ->setStartAt($report->start_at ? Carbon::parse($report->start_at) : null)
            ->setEndAt($report->end_at ? Carbon::parse($report->end_at) : null)
