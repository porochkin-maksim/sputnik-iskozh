            ...
            <div class="container-fluid">
                <div v-if="counter.isInvoicing"
                    ...
                    <template v-if="localHistory?.id">
                        При обновлении показаний будет автоматически пересчитана транзакция к регулярному счёту текущего периода, либо будет создан новый доходный счёт
                    </template>
                    <template v-else>
                        При добавлении показаний будет автоматически создана транзакция к регулярному счёту текущего периода, либо будет создан новый доходный счёт
                    </template>
                </div>
                <div class="mt-2">
