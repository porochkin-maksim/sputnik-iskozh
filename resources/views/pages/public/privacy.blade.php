...
@section(SectionNames::CONTENT)
    {{ Breadcrumbs::render(RouteNames::PRIVACY) }}
    ...
    <div class="page-hero">
        @include('layouts.partial.page-title', [
            ...
            'text' => RouteNames::name(RouteNames::PRIVACY),
        ])
        <div class="page-hero__lead">
            Политика обработки персональных данных и порядок работы с формами сайта.
        </div>
    </div>
    <div id="inputResult"
         class="privacy-policy-page page-section page-card p-3 p-lg-4">
        <div class="row privacy-policy-section mt-0">
            <div class="col">
                ...
                <div class="descr">
                    ...
                    данных, предпринимаемые <span class="link mark owner-name-field"
                                                  id="owner-name-value"
                                                  data-scroll-to="#owner-name-field">СНТ «Спутник-Искож»</span> (далее&nbsp;— Оператор).
                </div>
                <div class="ol">
                    <div class="li">
        ...
        <div class="row privacy-policy-section">
            <div class="col">
                ...
                <div class="ol">
                    ...
                    <div class="li">
                        ...
                        <span class="link mark owner-email-field"
                              data-scroll-to="#owner-email-field">snt.sputnik-iskozh@yandex.ru</span>
                    ...
                    <div class="li">
                        ...
                        и&nbsp;Политикой конфиденциальности. Субъект персональных данных должен
