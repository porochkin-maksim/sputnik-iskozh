...
OUTPUT_FILE="${DOMAIN_DIR}/Validators/${ENTITY_NAME}Validator.php"

if [ -f "$OUTPUT_FILE" ]; then
    echo -e "${YELLOW}Skipped Validator (exists): ${OUTPUT_FILE}${NC}"
    exit 0
fi
...
namespace Core\Domains\\${ENTITY_NAME}\Validators;
